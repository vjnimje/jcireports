  ...
  <div class="container">
    <div class=" row">
      <div class="col-md-3 mb-4 ms-auto">
        <div>
          <a href="#">
            <img style="max-height:100px;" src="<?php echo base_url(); ?>assets/front/images/logo.png" class="mb-3" alt="main_logo">
          </a>
        </div>
        <div>
      ...
      <div class="col-12">
        <div class="text-center">
          <p class="text-dark my-4 text-sm font-weight-normal">
            All rights reserved. Copyright © <script>document.write(new Date().getFullYear())</script><a href="#" target="_blank">JCI Zone IX</a>.
          </p>
        </div>
      </div>
    </div>
...
<script src="<?php echo base_url(); ?>assets/front/js/plugins/perfect-scrollbar.min.js"></script>




<!--  Plugin for TypedJS, full documentation here: https://github.com/inorganik/CountUp.js -->
<script src="<?php echo base_url(); ?>assets/front/js/plugins/countup.min.js"></script>





<script src="<?php echo base_url(); ?>assets/front/js/plugins/choices.min.js"></script>



<script src="<?php echo base_url(); ?>assets/front/js/plugins/prism.min.js"></script>
<script src="<?php echo base_url(); ?>assets/front/js/plugins/highlight.min.js"></script>



<!--  Plugin for Parallax, full documentation here: https://github.com/dixonandmoe/rellax -->
<script src="<?php echo base_url(); ?>assets/front/js/plugins/rellax.min.js"></script>
<!--  Plugin for TiltJS, full documentation here: https://gijsroge.github.io/tilt.js/ -->
<script src="<?php echo base_url(); ?>assets/front/js/plugins/tilt.min.js"></script>
<!--  Plugin for Selectpicker - ChoicesJS, full documentation here: https://github.com/jshjohnson/Choices -->
<script src="<?php echo base_url(); ?>assets/front/js/plugins/choices.min.js"></script>


<!--  Plugin for Parallax, full documentation here: https://github.com/wagerfield/parallax  -->
<script src="<?php echo base_url(); ?>assets/front/js/plugins/parallax.min.js"></script>


<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDTTfWur0PDbZWPr7Pmq8K3jiDp0_xUziI"></script>
<script src="<?php echo base_url(); ?>assets/front/js/material-kit.min.js?v=3.0.0" type="text/javascript"></script>
