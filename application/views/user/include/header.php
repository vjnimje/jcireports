...
<link id="pagestyle" href="<?php echo base_url(); ?>assets/front/css/material-kit.css?v=3.0.0" rel="stylesheet" />
...
<nav class="navbar navbar-expand-lg  blur border-radius-xl top-0 z-index-fixed shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
  <div class="container-fluid px-0">
    <a class="navbar-brand font-weight-bolder ms-sm-3" href="<?php echo base_url();?>" rel="tooltip" title="Designed and Coded by Creative Tim" data-placement="bottom" target="_self">
      <img style="max-height: 100px;" src="<?php echo base_url(); ?>assets/front/images/logo.png">
    </a>
